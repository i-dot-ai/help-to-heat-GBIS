...
type Inputs = Pick<Questions, 'monthlySpending'>
...
export const MonthlySpending = () => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <GovUK.Fieldset>
        <GovUK.Fieldset.Legend size="M">monthlySpending</GovUK.Fieldset.Legend>

        <GovUK.FormGroup error={submitCount > 0 && !!errors?.monthlySpending?.message}>
          {/* <GovUK.Label mb={4}>
