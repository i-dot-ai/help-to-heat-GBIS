...
type Inputs = Pick<Questions, 'currentEnergySystems'>
...
export const CurrentEnergySystems = () => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <GovUK.Fieldset>
        <GovUK.Fieldset.Legend size="M">currentEnergySystems</GovUK.Fieldset.Legend>

        <GovUK.FormGroup
          error={submitCount > 0 && !!errors?.currentEnergySystems?.message}
        >
          {/* <GovUK.Label mb={4}>
